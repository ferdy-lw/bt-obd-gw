...
use esp_idf_svc::{
    bt::{BdAddr, BtClassicEnabled, BtDriver},
    sys::*,
};

use super::bt_singleton::BtSingleton;
...
pub fn nul_to_invalid_arg(_err: NulError) -> EspError {
    EspError::from_non_zero(core::num::NonZeroI32::new(ESP_ERR_INVALID_ARG).unwrap())
}

pub fn to_cstring_arg(value: &str) -> Result<CString, EspError> {
